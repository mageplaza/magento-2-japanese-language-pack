...
2. [Install Japanese Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Japanese language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active Japanese language pack {#active}
